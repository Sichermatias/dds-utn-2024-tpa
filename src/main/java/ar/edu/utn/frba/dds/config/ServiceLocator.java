    ...
    public static <T> T instanceOf(Class<T> componentClass) {
        ...
        if (!instances.containsKey(componentName)) {
            if(componentName.equals(LoginController.class.getName())) {
                ...
                ColaboracionController instance = new ColaboracionController(new ColaboradorRepositorio(), new HeladerasRepositorio(), new PremioRepositorio(), new ColaboracionService(new ColaboradorRepositorio(), new ColaboracionRepositorio(), new DonacionDineroRepositorio(), new TransaccionService()), new ModeloRepositorio());
                instances.put(componentName, instance);
            }
